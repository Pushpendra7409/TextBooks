...
function Navbar() {
  ...
  return (
    <>
    <div className= {`max-w-screen-2xl container z-100 mx-auto md:px-20 px-4 sticky top-0 z-50 left-0 right-0
      ${
       sticky
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">TextBooks</a>
  </div>
